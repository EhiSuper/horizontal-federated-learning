...
<div id="options">
    <form action="<%=request.getContextPath()%>/ExperimentInfo" method="post">
        ...
        <br>
        <label for="randomClientsSeed">Random clients Seed: </label><input id="randomClientsSeed" name="randomClientsSeed"  type="number" value="<%=experiment.getRandomClientsSeed()%>"><br>
        <label for="timeout">Timeout: </label><input id="timeout" type="number" name="timeout" value="<%=experiment.getTimeout()%>"><br>
        <label for="maxAttemptsClientCrash">Max Attempt Clients Crash: </label><input id="maxAttemptsClientCrash" name="maxAttemptsClientCrash"  value="<%=experiment.getMaxAttemptsClientCrash()%>" readonly><br>
        ...
        %>
            ...
            <br>
            <label for="epsilon">Epsilon: </label><input id="epsilon" name="epsilon" type="number" min="0" max="1" step="0.01" value="<%=algorithm.getEpsilon()%>"><br>
            ...
            <br>
            <label for="FNorm">Result FNorm: </label><input id="FNorm" name="FNorm" value="<%=algorithm.getfNorm()%>" readonly><br>
