...
<div id="options">
    <form action="<%=request.getContextPath()%>/Home" method="post">
        ...
        <label for="dataset">Dataset: </label><input id="dataset" type="text" name="dataset" value="https://raw.githubusercontent.com/deric/clustering-benchmark/master/src/main/resources/datasets/artificial/xclara.arff" required><br>
        <label for="numFeatures">Number of features: </label><input id="numFeatures" type="number" name="numFeatures" value="3" required><br>
        ...
        <br>
        <label for="timeout">Timeout: </label><input id="timeout" type="number" name="timeout" value="25000" min="5000" required><br>
        ...
        <div id="KMeans" style="background-color: floralwhite; border-color: aquamarine; display: none">
            <label for="numClusters">Clusters: </label><input id="numClusters" type="number" name="numClusters" value="3" required><br>
            <label for="distance">Distance: </label>
            <select name="distance" id="distance" required>
                <option value="numba_norm">numba_norm</option>
            </select>
            <br>
            <label for="epsilon">Epsilon: </label><input id="epsilon" type="number" name="epsilon" value="0.05" step="0.01" required><br>
            <label for="seedCenters">Seed centers: </label><input id="seedCenters" type="number" name="seedCenters"  value="0" required><br>
